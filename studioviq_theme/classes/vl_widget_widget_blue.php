...
class Widget_Blue extends WP_Widget
{
    function __construct()
    {
        $widget_ops = array(
                'classname'     => 'blue-widget',
                'description'   => __( "Display some content + buttons")
            );
        parent::__construct( 'blue-widget', __('Blue Widget'), $widget_ops );
    }
...
?>
        <section class="blue-bg section-txt">
        	<div class="wrap">
	            ...
	            <?php endif; ?>
							...
							<ul class="contact-options-wrap">
								...
								<li><a href="<?php echo $url2; ?>" class="blue-btn"><?php echo $linkTitle2 ?></a></li>
								<?php endif; ?>
							</ul>
							<?php } ?>
