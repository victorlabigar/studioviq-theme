...
<!-- <div class="row"> -->
	<?php if(have_posts()) : while(have_posts()) : the_post(); ?>
		...
		<div id="project-top-bar">
			...
			<div class="col-xs-2">
				<?php if ($next_post != '') { ?>
				<a href="<?php echo get_permalink( $next_post->ID ); ?>" class="load"><div id="previous-project"><i class="fa fa-angle-left fa-3x"></i></div></a>
				<div id="previous-project-name" style="left: 8em; opacity: 0;"><h2 id="project-title"><?php echo $next_post->post_title; ?></h2></div>
				<?php } ?>
			</div>
			...
			<div class="col-xs-8">
				<div class="aligncenter">
					<a href="/?page_id=21"><i class="fa fa-th-list"></i></a>
				</div>			
			</div>
			...
			<div class="col-xs-2">
				...
				<a href="<?php echo get_permalink( $previous_post->ID ); ?>" class="load">
					<div id="next-project"><i class="fa fa-angle-right fa-3x  "></i></div>
				</a>
				<div id="next-project-name"><h2 id="project-title"><?php echo $previous_post->post_title; ?></h2></div>
				<?php } ?>
			</div>
					...
					<!-- <div class="container"> -->
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-4 col-md-offset-1">
								...
								<p id="project-tags"><?php the_tags( __( 'Tags: ', 'studioviq' ), ', ', '<br>'); ?></p>
								<p id="project-share">
										...
										<a class="social-share-btn fb" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $encoded_url; ?>" target="_blank">
											<i class="fa fa-facebook"></i> Deel op Facebook
										</a>
										<?php } ?>
										<a class="social-share-btn tw" target="_blank" href="http://twitter.com/home?status=Currently reading <?php echo urlencode(get_permalink()); ?>" alt="Deel dit project op Twitter">
											<i class="fa fa-twitter"></i> Deel op Twitter
										</a>
										<a class="social-share-btn lk" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink(); ?>&title=<?php the_title(); ?>&summary=<?php echo strip_tags(get_the_content()); ?>" alt="Deel dit project op LinkedIn">
											<i class="fa fa-linkedin"></i> Deel op LinkedIn
										</a>
